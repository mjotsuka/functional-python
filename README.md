# Functional Python [![](https://github.com/mjotsuka/functional-python/workflows/tests/badge.svg)](https://github.com/mjotsuka/functional-python/actions?query=workflow%3Atests)
